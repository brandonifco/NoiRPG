...
/// Weapons" (p.153-154) and corroborated by Ch 7: Spot Rules, "Extended Range" (p.170). See
...
{
    /// <summary>
    /// Within ceil(DEX/3) meters of the target. Easy. Ch 6, "Point Blank" (p.153); Ch 7,
    /// "Extended Range" (p.170): "The rules for point blank range still apply: missile attacks
    /// are Easy at a target less than DEX/3 in meters."
    /// </summary>
    PointBlank,

    /// <summary>
    /// Within the weapon's listed range. Unmodified. Ch 6, "Normal Range" (p.153).
    /// </summary>
    Normal,

    /// <summary>
    /// Beyond the listed range, up to double it. Difficult. Ch 6, "Medium Range" (p.153); Ch 7
    /// (p.170): "At medium range (double the basic range), it becomes Difficult."
    /// </summary>
    Medium,
    ...
    /// the base rating. Ch 6, "Long Range" (p.153); Ch 7 (p.170): "at long range (four times
